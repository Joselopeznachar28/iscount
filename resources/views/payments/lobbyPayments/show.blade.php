@extends('layouts.principal')
    ...
    <div class="row">
        <div class="col-sm-6">
            <label for="lobby_payment_id" class="form-label">Codigo de Pago</label>
            <input type="text" name="lobby_payment_id" id="lobby_payment_id" value="{{$payment->lobby_payment_id}}" class="form-control" disabled readonly>
        </div>
        <div class="col-sm-6">
    ...
    <div class="row">
        <div class="col-sm-4">
            <a href="{{route('payments/lobbyPayments.index')}}" class="btn btn-outline-primary" disab>Regresar</a>
        </div>
    </div>
    @endsection